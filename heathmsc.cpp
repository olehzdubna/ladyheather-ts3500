...
//	printf("+++ plot_sat_trail grid_x: %d, grid_y: %d, grid_r: %d, [%d] az: %g, el: %g: color: %d, dots: %d, trail_count: %d\n", grid_x, grid_y, grid_r, prn, az, el, color, dots, trail_count);
...
u08 m;
   ...
   for(i=1; i<=SUN_MOON_PRN; i++) { // !!!!! mooooo  now draw the sat vectors
	  ...
	  if(i < 30)
//	   printf("+++ draw_azel_sats [%d] az: %g, el: %g: sig: %g\n", i, sat[i].azimuth, sat[i].elevation, sat[i].sig_level);
